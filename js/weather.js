...
const ICONS = {
  ...
  "partly-cloudy": `<svg viewBox="0 -2 24 26" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="3.2"/><path d="M8 2.5v2M13.3 4.2l-1.4 1.4M2.7 4.2l1.4 1.4"/><path d="M8.5 20h9a3.8 3.8 0 0 0 .5-7.56A5.2 5.2 0 0 0 8.3 11.2a4 4 0 0 0-3.8 3.9A3.3 3.3 0 0 0 5.5 20"/></svg>`,
  cloudy: `<svg viewBox="0 -2 24 26" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 19h11a4 4 0 0 0 .5-7.97A5.5 5.5 0 0 0 7.3 9.7 4.2 4.2 0 0 0 3 13.8 4 4 0 0 0 6.5 19"/></svg>`,
  fog: `<svg viewBox="0 -2 24 26" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M6.5 15h11a4 4 0 0 0 .3-8 5.5 5.5 0 0 0-10.3-1.3A4.2 4.2 0 0 0 3 9.8 4 4 0 0 0 5 15"/><path d="M4 19h16M6 22h12"/></svg>`,
  drizzle: `<svg viewBox="0 -2 24 26" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M6.5 13h11a4 4 0 0 0 .3-8 5.5 5.5 0 0 0-10.3-1.3A4.2 4.2 0 0 0 3 7.8 4 4 0 0 0 5 13"/><path d="M8 17.5v2M12 17.5v2M16 17.5v2"/></svg>`,
  rain: `<svg viewBox="0 -2 24 26" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M6.5 12h11a4 4 0 0 0 .3-8 5.5 5.5 0 0 0-10.3-1.3A4.2 4.2 0 0 0 3 6.8 4 4 0 0 0 5 12"/><path d="M7.5 16l-1.5 3M12.5 16l-1.5 3M17.5 16l-1.5 3"/></svg>`,
  snow: `<svg viewBox="0 -2 24 26" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M6.5 12h11a4 4 0 0 0 .3-8 5.5 5.5 0 0 0-10.3-1.3A4.2 4.2 0 0 0 3 6.8 4 4 0 0 0 5 12"/><path d="M8 16.5v4M6 17.7l4 1.6M12 16.5v4M10 17.7l4 1.6M16 16.5v4M14 17.7l4 1.6"/></svg>`,
  thunder: `<svg viewBox="0 -2 24 26" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 12h11a4 4 0 0 0 .3-8 5.5 5.5 0 0 0-10.3-1.3A4.2 4.2 0 0 0 3 6.8 4 4 0 0 0 5 12"/><path d="M13 13l-3.5 5h3L11 22l4.5-6h-3z"/></svg>`,
};
